    ...
    <table class="wikitable mw-collapsible mw-made-collapsible" style="text-align: center">
      <tbody>
        ...
        <tr>
          ...
          <th>图标</th>
          <th>名称</th>
          <th colspan="2" style="border-right: solid 1px">效果</th>
        </tr>
        <tr>
          <th style="border-left: solid 1px">SP</th>
          <td>
            <skillIcon :scale="0.5" skill-level="" skill-type="SP" skill-bg="bg_special_2" skill1="img_icon_skill_sk-skr-05-idol-00-1" skill2="" skill3=""></skillIcon>
          </td>
        ...
        <tr>
          ...
          <td>
            <skillIcon :scale="0.5" skill-level="" skill-type="A" skill-bg="bg_strength_2" skill1="img_icon_skill-normal_vocal-up" skill2="img_icon_skill-normal_score-get" skill3=""></skillIcon>
          </td>
        ...
        <tr>
          ...
          <td>
            <skillIcon :scale="0.5" skill-level="5" skill-type="P" skill-bg="bg_strength_1" skill1="img_icon_skill-normal_vocal-up" skill2="img_icon_skill-normal_score-get" skill3=""></skillIcon>
          </td>
        ...
        <tr>
          ...
          <td style="border-bottom: solid 1px">
            <skillIcon :scale="0.5" skill-level="" skill-type="Y" skill-bg="bg_yell_1" skill1="img_icon_skill-normal_vocal-down" skill2="" skill3=""></skillIcon>
          </td>
...
:root {
  ...
  --color-base-dance: #38bbff;
  --color-base-visual: #ffb100;
  --color-base-stamina: #99dc66;
...
.maskedimage-vocal {
  mask-image: url('/img/icon/icon_parameter_vocal.png');
  background-color: var(--color-base-vocal);
}
.maskedimage-dance {
  mask-image: url('/img/icon/icon_parameter_dance.png');
  background-color: var(--color-base-dance);
}
.maskedimage-visual {
  mask-image: url('/img/icon/icon_parameter_visual.png');
  background-color: var(--color-base-visual);
}
.maskedimage-stamina {
  mask-image: url('/img/icon/icon_parameter_stamina.png');
  background-blend-mode: match-source;
  background-color: var(--color-base-stamina);
}
